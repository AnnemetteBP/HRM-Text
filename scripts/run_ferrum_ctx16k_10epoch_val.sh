...
RUN_ID="${RUN_ID:-ferrum-strategy-xxs-ctx16k-10epoch-val-20260718-222525}"
LOG="logs/${RUN_ID}.log"
CKPT="checkpoints/ferrum_strategy_xxs/${RUN_ID}"

mkdir -p logs checkpoints/ferrum_strategy_xxs
